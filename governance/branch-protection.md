...
Per [ADR-0015](decision-log.md#adr-0015-monorepo-with-directory-scoped-ownership), TOP relies on directory-scoped CODEOWNERS plus branch protection to enforce ownership boundaries inside a single repository.
