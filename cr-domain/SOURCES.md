...
|---|---|---|
| **"Comprehensive Lifecycle Map of Clinical Research"** (Doc 1, JTBD analysis) | phases, roles, artifacts, failure points, cost drivers | the operator model + constraints + ROI framing |
| **"Semantic Architecture for the Clinical Trial Lifecycle"** (Doc 2) | public-ontology landscape per phase; agent JTBD | crosswalk targets + projection targets |
