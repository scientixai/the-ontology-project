...
SPECS = [
    ...
    ("Essential records", "gcp-essential-records-conformant.ttl",
     ...
     ["doc-001"]),
    ("Pre-IND gate", "preind-conformant.ttl",
     "Pre-IND meeting &mdash; readiness", "IND 123456 &middot; Oppentix Bio", "Regulatory",
     [("Meeting", "Pre-IND"), ("Briefing book", "<span class='pill ok'>&#10003; on file</span>"),
      ("Question", "Is the proposed FIH starting dose acceptable?"),
      ("Proposed position", "<span class='pill ok'>&#10003; stated</span> &mdash; 10 mg (MABEL)"),
      ("Narrative coherence", "<span class='pill ok'>every tox finding &rarr; a clinical mitigation</span>"),
      ("30-day clock", "no hold in window &rarr; may proceed")],
     ["preind"]),
    ("Reporting &mdash; CSR", "csr-reporting-conformant.ttl",
     "CSR &mdash; results traceability", "OPP-201 CSR (ICH E3)", "Medical writing",
     [("Report", "OPP-201 Clinical Study Report"),
      ("&sect;11.4 Efficacy results", "<span class='pill ok'>presents Table 14.3.1</span>"),
      ("Reports result", "ORR = 0.42 <span class='muted'>(reproducible to ADaM)</span>"),
      ("Pre-specified in", "<span class='pill ok'>&#10003; SAP v1.0</span>"),
      ("Synopsis", "<span class='pill ok'>narrative &mdash; exempt</span>"),
      ("Rests on", "the leaf fact, by graph walk")],
     ["csr-opp201"]),
    ("Database lock", "closeout-dblock-conformant.ttl",
     "Post-lock value &mdash; why it&rsquo;s admissible", "Subject S-207 &middot; safety follow-up", "Data management",
     [("Late value", "grade 1 rash (resolved)"), ("Captured", "2026-07-12 &mdash; after the hard lock"),
      ("Hard lock", "<span class='pill ok'>2026-07-01</span>"),
      ("Under unlock", "<span class='pill ok'>&#10003; recorded</span> &mdash; scoped, reasoned"),
      ("Follow-up", "long-term safety programme"),
      ("Silent edit?", "<span class='pill ok'>impossible &mdash; audited, not a rewrite</span>")],
     ["postlock-obs"]),
    ("Submission &mdash; eCTD", "submission-ectd-conformant.ttl",
     "eCTD Module 5 &mdash; the manifest", "OPP-201 NDA", "Regulatory affairs",
     [("Submission", "NDA (eCTD Module 5)"),
      ("Built on lock", "<span class='pill ok'>&#10003; HARD lock</span> &mdash; a soft lock is caught"),
      ("Includes report", "OPP-201 CSR"), ("Includes dataset", "ADSL (ADaM)"),
      ("Includes Define", "Define-XML v2.1"),
      ("New source of truth?", "<span class='pill ok'>none &mdash; every arrow points at locked content</span>")],
     ["ectd-b1"]),
    ("Recruitment funnel", "recruitment-funnel-conformant.ttl",
     "Candidate R-014 &mdash; funnel to conversion", "OPP-101 &middot; referral program", "Recruitment",
     [("Candidate", "R-014 <span class='muted'>(PII-side, stays at site)</span>"),
      ("Source", "<span class='pill ok'>&#10003; attributed</span> &mdash; community-oncology referral"),
      ("Pre-screen", "proceed"), ("Screening", "<span class='pill ok'>eligible</span>"),
      ("Converted", "<span class='pill ok'>&#10003; via attested Enrollment</span> &rarr; S-014"),
      ("Screen-failed conversion?", "<span class='pill ok'>impossible &mdash; caught by shape</span>")],
     ["rf-recruit"]),
    ("Randomization", "randomization-conformant.ttl",
     "Blinded kit K-1187", "Subject S-042 &middot; IxRS", "RTSM",
     [("Kit", "K-1187 <span class='muted'>(what the site sees)</span>"),
      ("Under randomization", "R-0042 &middot; stratum ECOG 0-1"),
      ("Arm", "<span class='muted'>held by the randomization system</span>"),
      ("Emergency unblinding", "<span class='pill ok'>&#10003; reasoned + authorized</span> &mdash; never silent"),
      ("Assigned", "2026-03-02")],
     ["rz-kit"]),
    ("IMP accountability", "supply-accountability-conformant.ttl",
     "Dispensing &mdash; accountability chain", "Lot L-2209 &middot; Denver", "Pharmacy",
     [("Dispensed", "30 units to S-042 <span class='muted'>(pseudonymous)</span>"),
      ("From lot", "L-2209"), ("Excursion check", "<span class='pill ok'>released before dispensing</span>"),
      ("Returned", "4 units"), ("Destroyed", "<span class='pill ok'>4 units &mdash; authorized</span>"),
      ("Drug log", "a <b>projection</b> of these events &mdash; never a spreadsheet")],
     ["sp-dispense"]),
    ("Medical coding", "coding-conformant.ttl",
     "Code assignment &mdash; verbatim to PT", "'achy joints' &middot; MedDRA 27.0", "Coding",
     [("Verbatim", "&ldquo;achy joints&rdquo;"), ("Assigned", "MedDRA PT Arthralgia <span class='muted'>(BYOL IRI)</span>"),
      ("Method", "autocoder"), ("Dictionary version", "<span class='pill ok'>27.0 &mdash; carried</span>"),
      ("Human review", "<span class='pill ok'>&#10003; approved</span> &mdash; unreviewed autocode is flagged"),
      ("Coded by", "Sam Okafor, Medical Coder")],
     ["cd-assign-ae"]),
    ("Site closeout", "site-closeout-conformant.ttl",
     "Site closure &mdash; closed by evidence", "Denver Cancer Center", "ClinOps",
     [("Close-Out Visit", "<span class='pill ok'>&#10003; conducted</span> &mdash; Silvia Rodriguez, CRA"),
      ("IMP reconciliation", "<span class='pill ok'>balanced</span>"),
      ("Documents reconciliation", "<span class='pill ok'>balanced</span>"),
      ("ISF", "archived &middot; retention to 2051"),
      ("Closure", "<span class='pill ok'>rests on COV + reconciliations</span> &mdash; never a declaration")],
     ["sc-closure"]),
]
...
SCREEN_VIEW = {
    ...
    "Pre-IND gate": "preind",
    "Reporting &mdash; CSR": "csr",
    "Database lock": "dblock",
    "Submission &mdash; eCTD": "submission",
    "Recruitment funnel": "recruitment",
    "Randomization": "randomization",
    "IMP accountability": "supply",
    "Medical coding": "coding",
    "Site closeout": "site-closeout",
}
