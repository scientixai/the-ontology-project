...
SPECS = [
    ("Site activation", "phase15_activation_conformant.ttl",
     ...
     ["act1"]),
    ("Delegation", "phase1_oncology_fih_conformant.ttl",
    ...
    ("Enrollment", "phase1_oncology_fih_conformant.ttl",
     ...
     ["enroll-001"]),
    ("Informed consent", "phase1_oncology_fih_conformant.ttl",
     ...
     ["consent-001"]),
    ("Blood draw", "phase13_specimen_conformant.ttl",
     ...
     ["spec-1", "res-nab"]),
    ("EDC capture", "phase12_edc_conformant.ttl",
     ...
     ["obs1", "q1"]),
    ("Adverse event", "phase1_oncology_fih_conformant.ttl",
     ...
     ["ae-001"]),
    ("EOP2 gate", "phase7_eop2_conformant.ttl",
